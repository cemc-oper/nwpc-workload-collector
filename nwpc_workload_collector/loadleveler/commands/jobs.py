...
def collect_jobs(config, owner, repo,
    ...
    if output_style == 'show':
        ...
        if verbose:
            print("Posting loadleveler jobs for {owner}/{repo}...".format(owner=owner, repo=repo))
        ...
        if verbose:
            print("Posting loadleveler jobs for {owner}/{repo}...done".format(owner=owner, repo=repo))
...
def command(config_file, owner, repo,
    ...
    collect_jobs(config, owner, repo,
                 host, port, user, password,
                 output_style, post_url, content_encoding,
                 verbose)
